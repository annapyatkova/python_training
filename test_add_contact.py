...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("firstname").send_keys("Anna1")
        # middlename
        wd.find_element_by_name("middlename").click()
        wd.find_element_by_name("middlename").clear()
        wd.find_element_by_name("middlename").send_keys("Anna2")
        # lastname
        wd.find_element_by_name("lastname").click()
        wd.find_element_by_name("lastname").clear()
        wd.find_element_by_name("lastname").send_keys("Anna3")
        # nickname
        wd.find_element_by_name("nickname").click()
        wd.find_element_by_name("nickname").clear()
        wd.find_element_by_name("nickname").send_keys("Knyazeva")
        # photo
        wd.find_element_by_name("photo").send_keys("C:\\Users\Ann\Downloads\cat.jpg")
        # title
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").click()
        wd.find_element_by_name("title").clear()
        wd.find_element_by_name("title").send_keys("Training")
        # company
        wd.find_element_by_name("company").click()
        wd.find_element_by_name("company").clear()
        wd.find_element_by_name("company").send_keys("Software-Testing")
        # address
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys("Barnaul")
        # telephone
        # home
        ...
        wd.find_element_by_name("mobile").send_keys("9111111111")
        ...
        wd.find_element_by_name("fax").send_keys("qwerty")
        # email
        # email 1
        ...
        wd.find_element_by_name("homepage").send_keys("test.ru")
        # birthday
        wd.find_element_by_name("theform").click()
